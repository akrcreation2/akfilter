...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/open_link_trick/15")
VERIFY2_URL = environ.get('VERIFY2_URL', "publicearn.com")
VERIFY2_API = environ.get('VERIFY2_API', "42f7d6ca2b790a879d7a90f5688715da2aa946b2")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'publicearn.com')
SHORTLINK_API = environ.get('SHORTLINK_API', '42f7d6ca2b790a879d7a90f5688715da2aa946b2')
SHORTLINK_URL1 = environ.get('SHORTLINK_URL1', '')
SHORTLINK_API1 = environ.get('SHORTLINK_AP1I', '')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'False')), False)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "10")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Knmlpro2support_bot')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+_F10SCK3C3JjYzVl')
